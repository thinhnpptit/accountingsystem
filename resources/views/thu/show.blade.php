...
<div class="col-lg-12">
    <div class="block">
        ...
        <div class="title"><strong>thu tiết phiếu thu {{ $thu->id }}</strong></div>
                ...
                <link rel="stylesheet" href="/core/vendor/bootstrap/css/bootstrap.min.css">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="col-md-4 control-label" for="selectbasic">Số phiếu</label>
                                     <input class="form-control" value="{{ $thu->id }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="col-md-8 control-label" for="selectbasic">Ngày xuất</label>
                                    <input type="text" id="chartvalue" name="ngayban" class="form-control"
                                           value="{{ $thu->ngay }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="col-md-8 control-label" for="selectbasic">Lý do thu</label>
                                    <div class="show_product"></div>
                                    <textarea type="text" id="chartvalue" name="soluong" class="form-control"
                                              value="">{{ $thu->noi_dung }}</textarea>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="chartvalue" name="nhanvien" class="form-control"
                                        value="{{ \App\Models\NhanVien::find($thu->nhan_vien_id)->tenNV }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="col-md-12 control-label" for="selectbasic">Số phiếu bán hàng( nếu có)</label>
                                </div>
                                <div class="col-md-3">
                                    <label class="col-md-8 control-label" for="selectbasic">Số tiền thu</label>
                                </div>
                            </div>
                            @foreach($khoanthu as $kc)
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="text" id="chartvalue" name="thanhtien" class="form-control"
                                           value="{{ $kc->banhang_id }}">
