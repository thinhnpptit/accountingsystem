...
<div class="login-page">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="info d-flex align-items-center">
                        <div class="content">
                            <div class="logo">
                                <h1>HỆ THỐNG QUẢN LÝ KẾ TOÁN</h1>
                            </div>
                            <p>(Công Ty TNHH MTV Sinh vật cảnh Hoàng Linh)</p>
                        </div>
                    </div>
                </div>
                <!-- Form Panel    -->
                        ...
                        <div class="content">
                            ...
                            <form name="form" id="form1" action="" method="post" class="form-validate">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="login-username" class="label-material">Tài khoản</label>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror
                                </div><input type="submit" name="login" id="login" value="Đăng nhập" class="btn btn-primary">
    ...
    <div class="copyrights text-center">
        <p>PHÁT TRIỂN HỆ THỐNG THÔNG TIN QUẢN LÝ - NHÓM LỚP 4</p>
