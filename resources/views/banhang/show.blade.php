...
@section('content')
    <div class="col-lg-12">
        <div class="block">
            ...
            <div class="title"><strong>Hóa đơn bán hàng số {{ $ban->id }}</strong></div>
                    ...
                    <div id="printJS-form">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-sm-9">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="col-md-8 control-label" for="selectbasic">Số hóa đơn</label>
                                        <input class="form-control" value="{{ $ban->id }}">
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="chartvalue" name="nhanvien" class="form-control"
                                               value="{{ \App\Models\NhanVien::find($ban->nhanvien_id)->tenNV }}">
                                    </div>
                                </div>
                            </div>
                        </div>
