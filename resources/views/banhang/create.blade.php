            ...
            <div v-show='mathangs && mathangs.length ' class="table-responsive">
                ...
                <table id="Mathangs" class="display">
                    ...
                    <tr class="table-active">
                        <th class="table-danger">Mã Hàng</th>
                        <th>Tên Mặt hàng</th>
                    ...
                    <tr v-for='mathang in mathangs'>
                        <td class="table-active">@{{mathang.id}}</td>
                        <td class="table-secondary">@{{mathang.tenMH}}</td>
                        <td>@{{mathang.so_luong_trong_kho}}</td>
                        <td>@{{mathang.don_gia}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
