...
<div class="col-lg-12">
    <div class="block">
        ...
        <div class="title"><strong>Chi tiết phiếu chi {{ $chi->id }}</strong></div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="col-md-4 control-label" for="selectbasic">Số phiếu</label>
                                     <input class="form-control" value="{{ $chi->id }}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <label class="col-md-8 control-label" for="selectbasic">Lý do chi</label>
                                    <div class="show_product"></div>
                                    <textarea type="text" id="chartvalue" name="soluong" class="form-control"
                                              value="">{{ $chi->noi_dung }}</textarea>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="chartvalue" name="nhanvien" class="form-control"
                                        value="{{ \App\Models\NhanVien::find($chi->nhan_vien_id)->tenNV }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="col-md-8 control-label" for="selectbasic">Số tiền chi</label>
                                </div>
                            </div>
                            @foreach($khoanchi as $kc)
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="text" id="chartvalue" name="thanhtien" class="form-control"
                                           value="{{ $kc->muahang_id }}">
